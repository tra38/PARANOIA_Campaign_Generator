...
public static class CitizenGenerator
{
  ...
  {
    return $"{RandomName()}-{RandomClearance()}-{SectorGenerator.Generate()} (Secret Society: {RandomSociety()}, Job: {RandomJob()}, Personality: {RandomPersonality()})";
  }

  public static Func<string> RandomClearance = 
  ...
  public static Func<string> RandomJob = Generator.GenerateRule<string>(
    new List<string>
    {
      "Menial",
      "Clerical",
